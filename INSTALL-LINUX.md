...
> **Status:** Skrip build & konfigurasi electron-builder **sudah ada** (v1.0.4+). Versi produksi terbaru: **1.0.32**.  
...
- `release/Resource.Management-1.0.32.AppImage` (nama artefak mengikuti `package.json` / CI)
...
```bash
chmod +x "Resource.Management-1.0.32.AppImage"
./Resource.Management-1.0.32.AppImage
```
