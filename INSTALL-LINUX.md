...
> **Status:** Skrip build & konfigurasi electron-builder **sudah ada** (v1.0.4+). Versi produksi terbaru: **1.0.35**.  
...
- `release/Resource.Management-1.0.35.AppImage` (nama artefak mengikuti `package.json` / CI)
...
```bash
chmod +x "Resource.Management-1.0.35.AppImage"
./Resource.Management-1.0.35.AppImage
```
