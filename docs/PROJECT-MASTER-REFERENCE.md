...
**Versi aplikasi:** 1.0.37 (`package.json`)  
...
| 2026-08-06 | v1.0.37: TG Sync anti-orphan sidecar v14 + Errno 22 soft; Job Queue sticky header + Partial vs Failed; docs sync |
