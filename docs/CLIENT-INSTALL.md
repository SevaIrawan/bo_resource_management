...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.16.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.16-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.16.AppImage` |

```bash
chmod +x Resource.Management-1.0.16.AppImage
./Resource.Management-1.0.16.AppImage
```
