...
2. Pilih release terbaru (**v1.0.32**)
3. Unduh **hanya** file **`arm64.dmg`** — contoh:  
   **`Resource.Management-1.0.32-arm64.dmg`** (pakai **titik**, bukan strip `Resource-Management-…`)
...
- Jika unduh macet: minta IT jalankan **Fix release yml** untuk tag rilis terbaru, atau install manual **v1.0.32** `.dmg`
...
| Auto-update macet | Metadata yml / rilis lama | Install manual **v1.0.32** `.dmg` atau IT: Fix release yml |
