...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.12.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.12-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.12.AppImage` |

```bash
chmod +x Resource.Management-1.0.12.AppImage
./Resource.Management-1.0.12.AppImage
```
