...
## 4. Konfigurasi & installer (kondisi 1.0.4)
...
*Dokumen ini mencerminkan kondisi codebase per build **1.0.4**. Jika version atau alur berubah, perbarui bagian 4, 9, dan nomor versi di header.*
