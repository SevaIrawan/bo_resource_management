...
> **Status:** Skrip build & konfigurasi electron-builder **sudah ada** (v1.0.4+). Versi produksi terbaru: **1.0.33**.  
...
- `release/Resource.Management-1.0.33.AppImage` (nama artefak mengikuti `package.json` / CI)
