...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.14.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.14-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.14.AppImage` |

```bash
chmod +x Resource.Management-1.0.14.AppImage
./Resource.Management-1.0.14.AppImage
```
