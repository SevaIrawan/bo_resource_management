...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.28.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.28-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.28.AppImage` |

```bash
chmod +x Resource.Management-1.0.28.AppImage
./Resource.Management-1.0.28.AppImage
```
