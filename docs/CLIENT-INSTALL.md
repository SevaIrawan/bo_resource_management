...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.29.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.29-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.29.AppImage` |

```bash
chmod +x Resource.Management-1.0.29.AppImage
./Resource.Management-1.0.29.AppImage
```
