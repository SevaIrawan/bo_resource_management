...
| | |
|---|---|
| File | `Resource.Management.Setup.1.0.15.exe` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.15-arm64.dmg` |
...
| | |
|---|---|
| File | `Resource.Management-1.0.15.AppImage` |

```bash
chmod +x Resource.Management-1.0.15.AppImage
./Resource.Management-1.0.15.AppImage
```
